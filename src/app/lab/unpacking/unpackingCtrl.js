angular.module('unpacking')
    .controller('UnPackingCtrl', function (_, $scope, toaster, $rootScope, $state, $stateParams) {
        var vm = $scope
        vm.unpacking = []
        vm.currentIcebox = ''
        vm.packing = $rootScope.packing
        ...
        vm.saveBatch = function (unpacking) {
            ...
            _.each(vm.unpacking, function (box) {
                ...
                $rootScope.unpacking = _.union($rootScope.unpacking, box.items)
            })
        ...
        vm.saveReason = function () {
            ...
            toaster.pop('success', '', 'Saved Successfully')
            $state.go('lab.separation', $stateParams)
        }
